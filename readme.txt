...
1. First clone the project using this command:
    >git clone https://github.com/Axopher/KhaltiPaymentTesting.git

2. After that, run the code from command prompt terminal:
